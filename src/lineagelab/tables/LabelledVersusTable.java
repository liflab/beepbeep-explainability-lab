 ...
 */
public class LabelledVersusTable extends Table
{
	/**
	...
	/**
   * The name of the label to read in each experiment
   */
  protected final String m_label;
	 ...
	 */
	public LabelledVersusTable(String label, String parameter)
	{
		super();
		m_label = label;
	 ...
	 */
	public LabelledVersusTable(String label, String parameter, String caption_x, String caption_y)
	{
		super();
		m_label = label;
		m_parameter = parameter;
	 ...
	 * @param label The name of the label for this pair
	 * @param experiment_x The first experiment of the pair
	 * @param experiment_y The second experiment of the pair
	 * @return This table
	 */
	public LabelledVersusTable add(String label, Experiment experiment_x, Experiment experiment_y)
	{
		m_pairs.add(new ExperimentPair(label, experiment_x, experiment_y));
		return this;
	}
	...
	{
		TempTable table = new TempTable(getId(), m_label, m_captionX, m_captionY);
		table.setId(getId());
      ...
      else
      {
        te.put(m_captionY, y);
			...
			te.put(m_label, label);
			te.addDependency(m_label, new ExperimentValue(pair.getExperimentX(), m_label));
	...
	public static class ExperimentPair
	{
	  ...
	  protected final String m_label;
		 ...
		 * @param label The label for this pair of experiments
		 * @param experiment_x The first experiment
		 * @param experiment_y The second experiment
		 */
		public ExperimentPair(String label, Experiment experiment_x, Experiment experiment_y)
		{
			super();
			m_label = label;
		...
		/**
		 * Gets the label for the pair of experiments
		 * @return The label
		 */
